...
OBJ_PATH=obj
print_help() {
    echo "ctool.sh submodule <model name> [comments]"
    echo "ctool.sh source <source name> [comments]"
}
...
create_test_file() {
    ...
    text=$text"#include \"wmj_types.h\"\n"
    text=$text"#include \"wmj_defines.h\"\n"
    text=$text"#include \"wmj_delog.h\"\n"
